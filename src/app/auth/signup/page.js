...
export default function SignupPage() {
  ...
  return (
    <TubesBackground 
      ...
      tubeCount={10}
    >
      <div className="min-h-screen flex flex-col lg:flex-row items-center lg:items-start lg:pt-20 justify-center lg:justify-start px-4 sm:px-8 pb-32 sm:pb-0 transition-colors duration-500 text-white">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 z-10">
        <motion.div
          ...
          className="w-full lg:w-1/2 max-w-[310px] sm:max-w-[420px] lg:max-w-[500px] lg:pl-4 mt-6 sm:mt-12 lg:mt-0 mb-8 mx-auto lg:mx-0"
        >
          ...
          >
            {darkMode ? (
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] uppercase tracking-widest font-black text-yellow-400">Light Mode</span>
              </div>
            ) : (
              <div className="flex items-center gap-2">
