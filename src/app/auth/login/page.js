...
function LoginContent() {
  ...
  return (
    <TubesBackground 
      ...
      tubeCount={10}
    >
      <div className="min-h-screen flex flex-col lg:flex-row items-center lg:items-start lg:pt-20 justify-center lg:justify-start px-4 sm:px-8 transition-colors duration-500">
