                    ...
                    <div className="relative p-[2px] bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-[2.5rem] shadow-2xl overflow-hidden mb-12">
                        ...
                        {displayedUsers.map((u) => {
                            ...
                            return (
                                <div 
                                    key={u._id} 
                                    className={`relative p-[1.5px] rounded-[2rem] transition-all hover:scale-[1.01] shadow-xl ${isSelected ? "bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 shadow-blue-500/20" : "bg-gradient-to-r from-blue-500/50 via-purple-500/50 to-pink-500/50 border border-white/5"}`}
                                >
                                    <div 
