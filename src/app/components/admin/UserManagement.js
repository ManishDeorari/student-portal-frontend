                            ...
                            <div className="space-y-4 p-2 sm:p-4">
                                ...
                                {displayedUsers.slice(0, displayLimit).map((u) => {
                                    ...
                                    return (
                                        <div
                                            key={u._id}
                                            className={`relative p-[1px] rounded-[2rem] transition-all hover:scale-[1.01] shadow-xl ${isSelected ? "bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 shadow-blue-500/20" : "bg-gradient-to-r from-blue-500/50 via-purple-500/50 to-pink-500/50 border border-white/5"}`}
                                        >
                                            <div
                                                onClick={() => toggleSelect(u._id)}
                                                className={`${darkMode ? "bg-black" : "bg-white"} rounded-[calc(2rem-1.5px)] p-3 sm:p-5 flex flex-wrap md:flex-nowrap items-center gap-3 sm:gap-4 cursor-pointer relative z-10 transition-colors ${isSelected ? (darkMode ? "bg-blue-950/20" : "bg-blue-50/50") : ""}`}
                                            >
                                                {/* Checkbox */}
                                                ...
                                                <div className="w-full md:w-48 flex items-center justify-end gap-2 shrink-0 md:ml-auto" onClick={(e) => e.stopPropagation()}>
                                                    ...
                                                    <button
                                                        ...
                                                        className={`p-2.5 bg-red-600/5 hover:bg-red-600 border border-red-500 text-red-500 hover:text-white rounded-xl transition-all active:scale-95 ${u.isMainAdmin ? "opacity-20 cursor-not-allowed" : ""}`}
                                                        title="Delete User"
                                                    >
