            ...
            <div className="flex relative z-10 h-screen overflow-hidden">
                ...
                <div className="flex-1 flex flex-col h-screen overflow-hidden">
                    ...
                    <div className="shrink-0 z-20 bg-transparent border-none">
                        <div className="max-w-4xl mx-auto w-full px-2 sm:px-4 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar pb-20">
                        <div className="max-w-4xl mx-auto w-full px-2 sm:px-4 lg:px-8 mt-2 mb-8 flex flex-col sm:flex-row items-center gap-4">
                            <button
                                onClick={() => router.back()}
                        ...
                        <div className="max-w-3xl mx-auto w-full px-2 sm:px-4 lg:px-8">
